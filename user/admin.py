...
#         if obj.is_superuser:
#             return format_html(
#                 '<span style="color: #FF0000; font-weight: bold;">Superuser</span>'
#             )
#         elif obj.is_staff:
#             return format_html(
...
#         else:
#             return format_html(
#                 '<span style="color: #00AA00;">Regular User</span>'
#             )
...
#         # Ensure the colored_permission_status is included
#         list_display = list(super().get_list_display(request))
#         if 'colored_permission_status' not in list_display:
#             list_display.append('colored_permission_status')
#             return list_display
